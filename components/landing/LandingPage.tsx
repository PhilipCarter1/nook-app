        ...
        <div className="mx-auto max-w-7xl px-6 pb-24 pt-20 sm:pb-32 lg:flex lg:px-8 lg:py-40">
          ...
          >
            <div className="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
              <div className="relative w-full max-w-5xl h-96 lg:h-[500px] rounded-2xl bg-gradient-to-br from-nook-purple-500 via-nook-purple-600 to-nook-purple-700 shadow-2xl ring-1 ring-white/10 overflow-hidden">
                {/* Dashboard mockup */}
                <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent"></div>
                <div className="relative h-full flex items-center justify-center p-8">
                  <div className="text-center text-white">
                    <Building2 className="mx-auto h-16 w-16 mb-6 opacity-90" />
                    <h3 className="text-3xl font-bold mb-4">Nook Dashboard</h3>
                    <p className="text-xl opacity-90 mb-6">Modern Property Management Platform</p>
      ...
      <div className="bg-white py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="grid grid-cols-1 gap-y-8 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 sm:gap-y-10">
              {stats.map((stat) => (
                <motion.div
                  key={stat.label}
                  initial={{ opacity: 0, y: 20 }}
                ...
                >
                  <div className="text-3xl font-bold text-nook-purple-600">{stat.value}</div>
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {features.map((feature, index) => (
                ...
                >
                  <Link
                    href="/features"
                    className="group relative rounded-xl border border-gray-200 bg-white p-8 hover:border-nook-purple-300 hover:shadow-lg transition-all duration-200"
                  >
                    ...
                    <div className="flex items-center text-nook-purple-600 font-medium">
                      Learn more
